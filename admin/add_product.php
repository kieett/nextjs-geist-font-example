...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($name) || empty($price) || empty($category_id)) {
        ...
        try {
            ...
            $stmt = $conn->prepare("INSERT INTO products (name, slug, description, price, sale_price, category_id, stock, image, featured) 
                                  VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
            
            $stmt->execute([$name, $slug, $description, $price, $sale_price, $category_id, $stock, $image, $featured]);
...
<head>
    ...
    <title>Thêm sản phẩm mới - Nike Store Admin</title>
        ...
        <div class="flex-1 overflow-x-hidden overflow-y-auto">
            <div class="container mx-auto px-6 py-8">
                <div class="flex justify-between items-center mb-8">
                    <h2 class="text-3xl font-semibold text-gray-800">Thêm sản phẩm mới</h2>
